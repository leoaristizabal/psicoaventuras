      ...
      <div className="contact__container container grid">
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">psicoaventuras.vzla@gmail.com</span>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+58 412 0426747</span>

              <a
                href="https://api.whatsapp.com/send?phone=4120426747&text=Hola,%20¿cómo%20estás?"
                className="contact__button"
              >
                Escribeme{" "}
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">@Psicoaventuras</span>
        ...
        <div className="contact__content">
          ...
          className="contact__form">
            ...
            <button className="button button--flex1">
              Enviar Mensaje
              <svg
                class="button__icon"
